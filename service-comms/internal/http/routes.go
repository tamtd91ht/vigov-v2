...
func Register(mux *http.ServeMux, d Deps) {
	...
	// Scoped.Query binds `tenant_id` from the context (rule 1, invariant 5), and a token issued by
	// another commune is refused by authz.AnyAuthenticated before any query runs. What is accepted
