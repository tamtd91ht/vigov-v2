...
def main() -> None:
    ...
    L.append("")
    L.append("Trục ở đây là **module kho mã**. Ai hỏi *\"phân hệ nào dùng được rồi\"* thì đó là một")
    L.append("câu khác, trục khác, người đọc khác → `kb/90-ephemeral/tien-do-san-pham.md` (`/tien-do-san-pham`).")
    L.append("Hai tệp LIÊN KẾT chứ không chép của nhau (luật 9, bất biến 2).")
    L.append("")
