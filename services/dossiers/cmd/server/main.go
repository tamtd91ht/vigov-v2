...
import (
	...
	svchttp "github.com/vihat/vigov/services/dossiers/internal/http"
	"github.com/vihat/vigov/services/dossiers/migrations"
)
...
func chayMigration(log *slog.Logger) error {
	...
	if err := db.PingContext(ctx); err != nil {
		return fmt.Errorf("dossiers: không nối được cơ sở dữ liệu: %w", err)
	}
