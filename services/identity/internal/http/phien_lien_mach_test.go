...
//
// Production passes the same pointer to both — see services/identity/cmd/server/main.go, step 5.
...
func TestNoiHaiSignerKhacNhauThiTokenVuaPhatKhongGiaiDuoc(t *testing.T) {
	// THE MIS-WIRING, WRITTEN DOWN. This is what services/identity/cmd/server/main.go must never
