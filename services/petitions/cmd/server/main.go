...
import (
	...
	svchttp "github.com/vihat/vigov/services/petitions/internal/http"
	"github.com/vihat/vigov/services/petitions/migrations"
)
...
func main() {
	...
	if err := chayMigration(log); err != nil {
		log.Error("migration không chạy được", "service", "petitions", "err", err)
		os.Exit(1)
	}
