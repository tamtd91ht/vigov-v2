-- petitions — audit_log: turn "append-only" from a comment into a database constraint.
--
...
-- pkg/audit.Write only ever INSERTs. Nothing in the system loses a path it was using.
--
