// Command apidoc turns the route declarations in */internal/ into two generated
...
const canhBao = "Code generated by tools/apidoc. DO NOT EDIT BY HAND — run `make kb` to regenerate. " +
	...
	"The source of truth is the route declaration in */internal/."
...
type cauHinh struct {
	Root     string // repository root — every top-level service directory is scanned
