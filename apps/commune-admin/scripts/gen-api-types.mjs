...
//   services/*/internal/ → tools/apidoc sinh openapi.json → tệp này sinh schema.gen.ts. Một
...
const HOP_DONG = resolve(thuMuc, "../../../kb/20-contracts/openapi.json");
...
function sinh(hopDong) {
  ...
  ra.push("// services/*/internal/). Sinh lại: npm run gen:api — trong apps/commune-admin.");
  ra.push("//");
