...
// checkerGia mirrors services/identity/internal/store/checker.go: it matches on
...
func TestPrincipalIDLaIDNoiBoChuKhongPhaiMaCanBo(t *testing.T) {
	...
	// (services/identity/internal/store/checker.go:38). Putting cb.Ma there matches no row, so
