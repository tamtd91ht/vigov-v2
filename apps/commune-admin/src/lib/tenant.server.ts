 ...
 *   phơi ra gRPC (`services/platform/internal/grpc`), và route HTTP `GET /api/v1/communes`
 *   trong `services/platform/internal/http/routes.go` vẫn đang là chú thích "chưa chốt".
 *
