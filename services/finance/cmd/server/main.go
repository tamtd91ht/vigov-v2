...
import (
	...
	svchttp "github.com/vihat/vigov/services/finance/internal/http"
	"github.com/vihat/vigov/services/finance/migrations"
)
...
func chayMigration(log *slog.Logger) error {
	...
	if err := db.PingContext(ctx); err != nil {
		return fmt.Errorf("finance: không nối được cơ sở dữ liệu: %w", err)
	}
