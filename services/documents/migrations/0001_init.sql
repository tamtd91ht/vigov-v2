...
-- TODO(skeleton): business tables for documents.
-- Declared entities (see README): incoming_documents, outgoing_documents, document_numbers, routing_steps
--
