...
// migrations/0003_danh_muc_loai_van_ban.sql, function `danh_muc_ba_tang`, a BEFORE UPDATE OR
...
// `loai_van_ban_re_nhanh_thi_he_thong` refuses ma_nguon_re_nhanh on a `don-vi` row, because the
...
func (l LoaiVanBan) Tang() Tang { return TangCua(l.Nguon, l.MaNguonReNhanh) }
