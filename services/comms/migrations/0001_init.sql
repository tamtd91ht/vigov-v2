...
-- TODO(skeleton): business tables for comms.
-- Declared entities (see README): articles, radio_bulletins, videos, map_layers, map_pins, gov_contacts, notifications
--
